...
if ((isset($_COOKIE['XQS']) || isset($_COOKIE['segid'])) && (empty($_GET) || $_GET['dev'])) {
    ...
    if ($XQS_array['utm_content'] != 'null' && $XQS_array['utm_source'] != 'null') {
        $XQS_utm_content = $XQS_array['utm_content'];
        $XQS_utm_source = $XQS_array['utm_source'];
        $XQS_utm_slide = $XQS_array['utm_slide'];
    }
...
if (isset($_GET['utm_source']) || isset($XQS_utm_source)) {
    $taboola = ($_GET['utm_source'] == 'tala' || $_GET['utm_source'] == 'talas' || $XQS_utm_source == 'tala' || $XQS_utm_source == "talas") ? true : false;
    $outbrain = ($_GET['utm_source'] == 'ouin' || $_GET['utm_source'] == 'ouins' || $XQS_utm_source == 'ouin' || $XQS_utm_source == "ouins") ? true : false;
    $geni = ($_GET['utm_source'] == 'geni' || $XQS_utm_source == "geni") ? true : false;
}
